...
@section('content')
    ...
    <section class="container mt-5 mb-5 card p-3">
        <div class="row ">
            ...
            <div class="col-5">
                ...
                <p style="font-size: 14px; font-weight: bold" class="text-black-50 mb-0">
                    Tanggal: {{ $product->tgl_berangkat }} </p>
                <p style="font-size: 14px; font-weight: bold" class="text-black-50 mb-0">Terisi : {{ $kuota }}
                    Orang </p>
    ...
    <section class="container">
        ...
        <div class="text-left mt-2 mb-3">
            <h2>Paket tour kami yang lain</h2>
        </div>
