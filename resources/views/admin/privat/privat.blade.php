            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-white d-inline-block mb-0">Data Private Tour</h6>
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                <li class="breadcrumb-item"><a href="#"><i class="fas fa-home"></i></a></li>
                                <li class="breadcrumb-item"><a href="#">Data Private Tour</a></li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-lg-6 col-5 text-right">
                        <a href="/admin/privat/tambahprivat" class="btn btn-md btn-neutral">Tambah Data</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header border-0">
                        <h3 class="mb-0">Tabel Private Tour</h3>
                    </div>
                    <!-- Light table -->
                    <div class="table-responsive">
                        <table id="tabel" class="table align-items-center table-flush">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="sort text-center" data-sort="budget">Nama Private Tour</th>
                            ...
                            @foreach($produk as $p)
                                <tr>
                                    ...
                                    <td class="text-center">Rp. {{number_format($p->harga,0,',','.')}} / orang</td>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="/admin/privat/editprivat/{{$p->id}}?aksi=privat">Edit</a>
...
@section('script')
    <script>
        ...
        function hapus(id, name) {
            Swal.fire({
                title: 'Apa anda yakin untuk menghapus Private Tour '+name+' ?',
                icon: 'warning',
